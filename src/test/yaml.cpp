...
TEST(Yaml, toYamlCartesianPosition) {
	...
	ASSERT_TRUE(parsed.isApprox(dr::yaskawa::CartesianPosition{}));
}

TEST(Yaml, toYamliCartesianPosition) {
	ASSERT_EQ("{x: -0.100000, y: 1.200000, z: 2.300000i, rx: , ry: , rz: , configuration: , tool: , frame: }", toYaml(Eigen::Vector3d{-0.1, 1.2, 2.3}));
}
