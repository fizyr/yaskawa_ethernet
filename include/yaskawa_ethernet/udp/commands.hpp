...
namespace robot {
	...
	std::uint16_t readwrite_io                      = 0x78;
	std::uint16_t readwrite_register                = 0x79;
	std::uint16_t readwrite_int8_variable           = 0x7a;
	std::uint16_t readwrite_int16_variable          = 0x7b;
	std::uint16_t readwrite_int32_variable          = 0x7c;
	std::uint16_t readwrite_float_variable          = 0x7d;
	std::uint16_t readwrite_string_variable         = 0x7e;
	std::uint16_t readwrite_robot_position_variable = 0x7f;
	std::uint16_t readwrite_base_position_variable  = 0x80;
	std::uint16_t readwrite_external_axis_variable  = 0x81;
